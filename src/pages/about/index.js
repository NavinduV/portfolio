    ...
    >
      ...
      <div className="container mx-auto h-full flex flex-col xl:flex-row gap-x-10 relative z-10 pb-20 xl:pb-0">
        ...
        >
          ...
          {/* Content Container */}
          <div className="py-2 xl:py-4 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start w-full h-[480px] xl:h-[58vh] overflow-y-auto scrollbar-thin scrollbar-thumb-accent/50 scrollbar-track-transparent scrollbar-hide-buttons pr-2 md:pr-4 pb-48 xl:pb-4">
            <motion.div
              key={index}
